...
<template>
  <div
    v-if="showWarning"
    role="alert"
    class="alert fixed bottom-2 right-2 right-2 max-w-xl border-2 border-neutral bg-base-300 p-4"
  >
    <svg
    ...
    >
    <div>
      <button class="btn btn-sm btn-neutral" @click="hideWarning">I understand</button>
    </div>
  </div>
</template>
